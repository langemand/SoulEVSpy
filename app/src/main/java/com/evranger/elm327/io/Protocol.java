...
import com.evranger.elm327.commands.protocol.EchoCommand;
import com.evranger.elm327.commands.protocol.HeadersCommand;
import com.evranger.elm327.commands.protocol.LinefeedsCommand;
import com.evranger.elm327.commands.protocol.PrintVersionIdCommand;
import com.evranger.elm327.commands.protocol.RawCommand;
import com.evranger.elm327.commands.protocol.ResetAllCommand;
import com.evranger.elm327.commands.protocol.StopCommand;
import com.evranger.elm327.commands.protocol.can.CANAutomaticFormattingCommand;
import com.evranger.elm327.commands.protocol.can.CANSetProtocolCommand;
import com.evranger.elm327.commands.protocol.obd.OBDAdaptiveTimingCommand;
import com.evranger.elm327.commands.protocol.obd.OBDAllowLongMessagesCommand;
import com.evranger.elm327.commands.protocol.obd.OBDAutomaticallyReceiveCommand;
import com.evranger.elm327.commands.protocol.obd.OBDPrintSpacesCommand;
...
//DONT        addCommand(new org.hexpresso.elm327.commands.protocol.can.CANDisplayDataLengthCodeCommand(false));
        ...
        addCommand(new HeadersCommand(false));
...
//DONT        addCommand(new BasicCommand("AT FI")); // Try Fast Initialisation - returns "?" causing throw of MisunderstoodCommandException
        addCommand(new OBDAdaptiveTimingCommand(OBDAdaptiveTimingModes.TIMING_AUTO1));
        addCommand(new OBDAutomaticallyReceiveCommand());
        addCommand(new OBDAllowLongMessagesCommand());
        addCommand(new OBDPrintSpacesCommand(true));
        addCommand(new OBDSetTimeoutCommand(0x80)); // Attempt to fix issue where initial 09 02 returns "NO DATA"
        addCommand(new RawCommand("AT FE")); // Forget any previous events
