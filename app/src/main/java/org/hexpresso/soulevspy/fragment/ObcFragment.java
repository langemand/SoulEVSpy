 ...
 */
public class ObcFragment extends ListFragment implements CurrentValuesSingleton.CurrentValueListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        getActivity().setTitle(R.string.action_obc_information);
    ...
    public void onValueChanged(String trig_key, Object value) {
        Map<String, Object> vmcuVals = mValues.find("obc.");
